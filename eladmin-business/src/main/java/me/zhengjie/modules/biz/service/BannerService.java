...
public interface BannerService {
    ...
    */
    Map<String,Object> queryAll(BannerQueryCriteria criteria, Pageable pageable);
    ...
    * @throws IOException /
    */
    void download(List<BannerDto> all, HttpServletResponse response) throws IOException;
}