...
public class GenUtil {
    ...
    private static Map<String, Object> getGenMap(List<ColumnInfo> columnInfos, GenConfig genConfig) {
        ...
        // 大写开头的类名
        String className = Util.toCapitalizeCamelCase(genConfig.getTableName());
        // 小写开头的类名
        String changeClassName = StrUtil.toCamelCase(genConfig.getTableName());
        // 判断是否去除表前缀
        if (StrUtil.isNotEmpty(genConfig.getPrefix())) {
            className = Util.toCapitalizeCamelCase(StrUtil.removePrefix(genConfig.getTableName(), genConfig.getPrefix()));
        ...
        for (ColumnInfo column : columnInfos) {
            ...
            // 小写开头的字段名
            String changeColumnName = StrUtil.toCamelCase(column.getColumnName());
            // 大写开头的字段名
            String capitalColumnName = Util.toCapitalizeCamelCase(column.getColumnName());
